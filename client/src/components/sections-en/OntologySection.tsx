    ...
    <section id="ontology" className="py-24 md:py-32">
      <div className="container max-w-6xl">
        <SectionTitleEn
          ...
          subtitle="General-purpose LLMs don't understand enterprise 'domain dark knowledge' or SOPs. Without Ontology, AI Agents cannot achieve accuracy and behavioral consistency in enterprise scenarios."
        />
            ...
            <div className="relative rounded-lg overflow-hidden mb-6">
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <p className="text-sm font-mono text-cyan-glow">
                  Layer 2 · Neo4j GraphRAG · Enterprise Brain
                </p>
              </div>
            </div>
            ...
            <AnimatedSection direction="right" delay={0.3}>
              <div className="p-4 rounded-lg border border-dashed border-cyan-glow/30 bg-cyan-glow/5">
                <p className="text-sm text-cyan-glow/80 italic">
                  "Ontology is the bridge from general intelligence to specialized intelligence. Without it, LLMs are just clever but ignorant outsiders."
                </p>
              </div>
            </AnimatedSection>
          </div>
