...
const currentHW = [
  { icon: Cloud, labelEn: "Cloud GPU", descEn: "LLM inference (OpenAI / Claude API)" },
  { icon: HardDrive, labelEn: "Kafka + K8s", descEn: "Cloud-native stream processing & container orchestration" },
  { icon: Cpu, labelEn: "Edge Devices", descEn: "AI camera data processing" },
];
    ...
    <section id="hardware" className="py-24 md:py-32">
      <div className="container max-w-6xl">
        <SectionTitleEn
          ...
          subtitle="Evolution from cloud to edge — supporting massive Agent clusters and physical execution requires more than software alone."
        />
