            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <AnimatedSection direction="right">
                <GlowCard glowColor="cyan" className="p-6 h-full border-l-2 border-l-cyan-glow/50">
                  ...
                  <p className="text-xs text-cyan-glow/70 mb-4">业务 Harness</p>
                  <p className="text-sm text-muted-foreground leading-relaxed mb-1">
                  ...
                  <div className="p-3 rounded bg-cyan-glow/5 border border-cyan-glow/15">
                    ...
                    <p className="text-[10px] text-cyan-glow/70 mt-1">
          ...
          <div className="space-y-8">
            <AnimatedSection>
              <GlowCard className="p-8">
                ...
                <p className="text-sm text-muted-foreground/75 mb-6">Harness工程的信任屏障</p>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <ul className="space-y-1.5">
                      {[
                        ...
                        <li key={item.en} className="flex items-center gap-2 text-xs text-muted-foreground">
                          ...
                          {item.en} <span className="text-muted-foreground/65">{item.zh}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
                  ...
                  <div className="p-5 rounded-lg bg-purple-glow/5 border border-purple-glow/20">
                    ...
                    <p className="text-[10px] text-purple-glow/65 mb-3">反馈控制</p>
                    <p className="text-sm text-muted-foreground leading-relaxed mb-1">
            ...
            <AnimatedSection delay={0.15}>
              <GlowCard className="p-8">
                ...
                <p className="text-xs text-muted-foreground/75 mb-4">执行类型分类</p>
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="p-4 rounded bg-secondary/50">
                    ...
                    <p className="text-[10px] text-cyan-glow/60 mb-2">确定性计算控制</p>
                    ...
                    <p className="text-xs text-muted-foreground/65 mt-1">API契约校验、Linting、类型检查、数据格式验证等可精确判定的规则。</p>
                  </div>
                  <div className="p-4 rounded bg-secondary/50">
                    <h4 className="font-mono text-sm text-purple-glow mb-1">Inference Control</h4>
                    <p className="text-[10px] text-purple-glow/65 mb-2">推理控制</p>
                    ...
                    <p className="text-xs text-muted-foreground/65 mt-1">LLM作为裁判进行语义验证、意图一致性检查、业务逻辑合理性评估。</p>
                  </div>
                </div>
              </GlowCard>
            </AnimatedSection>
          ...
          <div className="space-y-8">
            <AnimatedSection>
              <GlowCard className="p-8">
                ...
                <p className="text-sm text-muted-foreground/75 mb-6">业务Harness的构建与演进</p>
                ...
                <div className="space-y-6">
                  <div className="p-5 rounded-lg bg-secondary/30 border border-panel-border/30">
                    ...
                    <p className="text-xs text-muted-foreground/75 mb-3">状态与身份的治理</p>
                  ...
                  <div className="p-5 rounded-lg bg-cyan-glow/5 border border-cyan-glow/20">
                    ...
                    <p className="text-xs text-cyan-glow/60 mb-3">护城河的复利效应</p>
                    <p className="text-sm text-muted-foreground leading-relaxed mb-1">
                    ...
                    <div className="grid grid-cols-3 gap-4 pt-4 border-t border-cyan-glow/10">
                      <div className="text-center">
                        ...
                        <p className="text-[10px] text-muted-foreground/65">处理过的订单</p>
                      </div>
                      <div className="text-center">
                        ...
                        <p className="text-[10px] text-muted-foreground/65">边缘案例库</p>
                      </div>
                      <div className="text-center">
                        ...
                        <p className="text-[10px] text-muted-foreground/65">持续蒸馏学习</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <AnimatedSection delay={0.15}>
              <div className="p-5 rounded-lg border border-dashed border-cyan-glow/30 bg-cyan-glow/5 max-w-3xl mx-auto text-center">
                ...
                <p className="text-xs text-cyan-glow/70 mt-2">
