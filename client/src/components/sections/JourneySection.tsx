          ...
          <AnimatedSection direction="left" className="relative mb-16">
            <div className="md:grid md:grid-cols-2 md:gap-12">
              <div className="md:text-right md:pr-8">
                ...
                <p className="text-sm text-muted-foreground/75 mb-4">迷信大模型的「通用能力」</p>
          ...
          <AnimatedSection direction="right" className="relative mb-16">
            <div className="md:grid md:grid-cols-2 md:gap-12">
              ...
              <div className="md:pl-8">
                ...
                <p className="text-xs text-cyan-glow/60 mb-4">认知转折</p>
                <h3 className="text-2xl font-bold mb-1">Foundation Models Are Not the Moat</h3>
                <p className="text-sm text-muted-foreground/75 mb-4">基础模型不是护城河</p>
                <p className="text-muted-foreground leading-relaxed">
                ...
                <p className="text-sm text-muted-foreground/65 leading-relaxed mt-2">
                  我们意识到，随着模型的快速迭代和开源，通用能力会迅速商品化甚至贬值。真正的护城河在于<strong className="text-foreground/90">业务Harness</strong>和<strong className="text-foreground/90">本体知识库（Ontology）</strong>。
                </p>
                <div className="mt-6 p-4 rounded-lg bg-cyan-glow/5 border border-cyan-glow/20">
                  ...
                  <p className="text-xs text-cyan-glow/60 mb-2">架构重构方向</p>
